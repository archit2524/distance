...
<div id="demo-top-bar">
  ...
  <div id="demo-bar-inside">
	...
	<div id="page-wrap">
		...
		<h1><font size=+4><u>RESULT</u></font></h1>
        ...
        <?php
            ...
            if ($answer30 == "D") { $totalCorrect++; }
            if ($answer31 == "A") { $totalCorrect++; }
            if ($answer32 == "C") { $totalCorrect++; }
            if ($answer33 == "D") { $totalCorrect++; }
            if ($answer34 == "A") { $totalCorrect++; }
            if ($answer35 == "A") { $totalCorrect++; }
            if ($answer36 == "C") { $totalCorrect++; }
            if ($answer37 == "B") { $totalCorrect++; }
	...
	* {
	...
	#demo-bar-badge a {
		...
		bottom: auto;
		margin: 0;
		background: url('https://www.logo.wine/a/logo/C%2B%2B/C%2B%2B-Logo.wine.svg') no-repeat;
		background-size: 70%;
		overflow: hidden;
		text-indent: -9999px;
	}
